...
Use #tool:vscode/askQuestions with current values shown:
...
These settings apply to future /plan-phase.md and /execute-phase.md runs.

Quick commands:
- /set-profile.md <profile> — switch model profile
- /plan-phase.md --research — force research
- /plan-phase.md --skip-research — skip research
- /plan-phase.md --skip-verify — skip plan check
```
